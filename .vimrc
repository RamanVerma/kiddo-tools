...
" Code completion hints for C family of languages, based on clang compiler
Plug 'Rip-Rip/clang_complete'
"" Find files and buffers and stuff
Plug 'vim-scripts/L9'
...
""" Ease of use """
" F1 = Compile using make
" F2 = Run the executable (not implemented yet)
" F3 = Save current buffer
" F4 = Save all buffers
" F5 = Fuzzy Finder (:FufFile) find a file
nnoremap <F1> :make!<cr>
nnoremap <F2> :make run<cr>
nnoremap <F3> :w<cr>
nnoremap <F4> :wa<cr>
nnoremap <F5> :FufFile<cr>
" Use F8 to toggle between paste mode and normal mode.
